...
describe('public api', () => {
	...
	const progress = 30
        ...
        const expectedStatement = '{"version":"1.0.3","object":{"objectType":"Activity","type":"http://adlnet.gov/expapi/activities/cmi.interaction","id":"http://www.awsome-courses.com/course-id","definition":{"name":{"en-US":"The Awesome course"},"description":{"en-US":"Select the right answers"}}},"verb":{"id":"http://adlnet.gov/expapi/verbs/failed","display":{"en-US":"failed"}},"actor":{"objectType":"Agent","account":{"name":"Alice","homePage":"http://alice.me"}},"authority":{"objectType":"Agent","account":{"name":"authority-username","homePage":"http://www.example.com/learning-record-provider"},"name":"Learning Record Provider"},"timestamp":"2020-01-01T00:00:00.000Z","result":{"score":{"scaled":0,"raw":0,"min":0,"max":278},"success":false,"completion":true,"duration":"PT0H0M48S","extensions":{"https://w3id.org/xapi/cmi5/result/extensions/progress":30}}}';
        expect(JSON.stringify(statement.getStatement())).toBe(expectedStatement);
    });
    ...
    test('A terminated statement example', () => {
        ...
        const expectedStatement = '{"version":"1.0.3","object":{"objectType":"Activity","type":"http://adlnet.gov/expapi/activities/cmi.interaction","id":"http://www.awsome-courses.com/course-id","definition":{"name":{"en-US":"The Awesome course"}}},"verb":{"id":"http://adlnet.gov/expapi/verbs/terminated","display":{"en-US":"terminated"}},"actor":{"objectType":"Agent","account":{"name":"Alice","homePage":"http://alice.me"}},"authority":{"objectType":"Agent","account":{"name":"authority-username","homePage":"http://www.example.com/learning-record-provider"},"name":"Learning Record Provider"},"timestamp":"2020-01-01T00:00:00.000Z"}';
	...
	const progress = 100
        ...
        const expectedStatement = '{"version":"1.0.3","object":{"objectType":"Activity","type":"http://adlnet.gov/expapi/activities/cmi.interaction","id":"http://www.awsome-courses.com/course-id","definition":{"name":{"en-US":"The Awesome course"},"description":{"en-US":"Select the right answers"}}},"verb":{"id":"http://adlnet.gov/expapi/verbs/passed","display":{"en-US":"passed"}},"actor":{"objectType":"Agent","account":{"name":"Alice","homePage":"http://alice.me"}},"authority":{"objectType":"Agent","account":{"name":"authority-username","homePage":"http://www.example.com/learning-record-provider"},"name":"Learning Record Provider"},"timestamp":"2020-01-01T00:00:00.000Z","result":{"score":{"scaled":0.57,"raw":5250,"min":0,"max":9292},"success":true,"completion":true,"duration":"PT0H0M48S","extensions":{"https://w3id.org/xapi/cmi5/result/extensions/progress":100}}}';
        expect(JSON.stringify(statement.getStatement())).toBe(expectedStatement);
    });
});
